;(function () {
	...
	var animateTeam = function() {
		if ( $('#fh5co-team').length > 0 ) {	
			$('#fh5co-team .fw-row:nth-child(2) > div').each(function( k ) {
	...
	var animateFeatureIcons = function() {
		if ( $('#fh5co-services').length > 0 ) {	
			$('#fh5co-services .fw-iconbox-image i').each(function( k ) {
	...
	$('body.single .fh5co-single-content p').addClass('animate-box');
